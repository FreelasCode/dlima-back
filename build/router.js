...
router.post("/admin/user/create", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, name, username, password, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                console.log("teste");
                _a = req.body, email = _a.email, name = _a.name, username = _a.username, password = _a.password;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
...
// Item routes 
router.post("/admin/item/create", StorageService_1.upload.single('image'), ItemController.createItem);
